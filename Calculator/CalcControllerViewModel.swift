...
//  Calculator
//
//  Created by Andrew Xu on 12/7/24.
//
...
// MARK: - Equals and Arithmetic Operations
extension CalcControllerViewModel {
    private func didSelectEqualsButton() {
        if let operation = self.operation,
           ...
           let secondNumber = self.secondNumber {
            ...
            // This will update the calculator based on previously selected number and arithmetic operation
